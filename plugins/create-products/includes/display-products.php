...
function display_published_products() {
    global $wpdb;
...
// Register shortcode for displaying published products
add_shortcode( 'display_published_products', 'display_published_products' );
